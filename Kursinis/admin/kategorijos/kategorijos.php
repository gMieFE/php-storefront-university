        ...
        <div class="content">
            ...
            <table>
                ...
                <?php while ($r = $res->fetch_assoc()):
                    ...
                    echo    "<td>" . $r['id'] . "</td>";
                    echo    "<td>" . $r['name'] . "</td>";
                    echo    "<td><a href='kategorijos_edit.php?id=".$r['id']."'><button  class='table-btn'>edit</button></a></td>";
                    echo    "<td ><a href='kategorijos_delete.php?id=" . $r['id'] . "'><button class='delete-btn'><i class='fa-solid fa-trash'></i></button></a></td>";
                    echo "</tr>";
                endwhile; ?>
